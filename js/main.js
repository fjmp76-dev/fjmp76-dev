...
const translations = {
  es: {
    ...
    'projects.p4.title': 'PlexRAG — Asistente de IA para Plex',
    'projects.p4.desc': 'Aplicación personal de IA generativa que conversa sobre tu biblioteca de Plex usando RAG, con modos LLM/Standard y Agent, autenticación con Google e indexado vectorial administrable.',
    'projects.p4.cta': 'Ver detalles del proyecto →',
    ...
    'plexrag.back': '← Volver al portafolio',
    'plexrag.eyebrow': '// proyecto destacado',
    'plexrag.title': 'PlexRAG',
    'plexrag.tagline': 'Un asistente conversacional de IA, con RAG, que responde preguntas sobre tu propia biblioteca de Plex — con modo estándar y modo Agent, autenticación con Google e indexado vectorial administrable.',
    'plexrag.cta.live': 'Ver la app en vivo ↗',
    'plexrag.cta.back': '← Volver al portafolio',
    'plexrag.overview.eyebrow': '// qué construí',
    'plexrag.overview.title': 'RAG de punta a punta sobre una biblioteca multimedia real',
    'plexrag.overview.p1': 'PlexRAG es una aplicación personal full-stack que indexa el catálogo de una biblioteca de Plex (películas, series, metadatos) en una base vectorial y permite hacer preguntas en lenguaje natural sobre ese contenido. El chat tiene dos modos: <strong>LLM / Standard</strong>, para respuestas directas basadas en el contexto recuperado, y <strong>Agent</strong>, donde el modelo puede orquestar herramientas para resolver consultas más complejas.',
    'plexrag.overview.p2': 'Un panel de administración permite sincronizar las secciones de la biblioteca de Plex y forzar un <em>reindexado</em> completo, mientras que la gestión de usuarios aplica control de acceso basado en roles (Admin / User) sobre un login con Google OAuth 2.0.',
    'plexrag.shot.caption': 'Interfaz de chat de PlexRAG en producción — modos LLM/Standard y Agent.',
    'plexrag.specs.eyebrow': '// especificaciones',
    'plexrag.specs.title': 'Cómo está construido',
    'plexrag.specs.s1.title': 'Pipeline RAG sobre Plex',
    'plexrag.specs.s1.desc': 'Sincronización de las secciones de la biblioteca de Plex y reindexado vectorial completo bajo demanda desde el panel de administración.',
    'plexrag.specs.s2.title': 'Autenticación y roles',
    'plexrag.specs.s2.desc': 'Login con Google OAuth 2.0 y control de acceso basado en roles (Admin / User) para las pantallas de administración.',
    'plexrag.specs.s3.title': 'Frontend en Angular',
    'plexrag.specs.s3.desc': 'SPA construida con Angular (v22) y servicios standalone que consumen la API vía HttpClient, con enrutamiento por secciones (chat, indexado, usuarios).',
    'plexrag.specs.s4.title': 'API en .NET 10',
    'plexrag.specs.s4.desc': 'Backend REST en ASP.NET Core Web API sobre .NET 10, desplegado en su propio subdominio, separado del frontend.',
    'plexrag.specs.s5.title': 'Contenedores Docker',
    'plexrag.specs.s5.desc': 'Frontend y backend empaquetados y desplegados como contenedores Docker independientes.',
    'plexrag.specs.s6.title': 'IA multi-cloud',
    'plexrag.specs.s6.desc': 'Modelos de lenguaje servidos desde Azure OpenAI y Google Cloud (Vertex AI / Gemini) para alimentar los modos LLM y Agent.',
    'plexrag.specs.s7.title': 'Git &amp; GitHub',
    'plexrag.specs.s7.desc': 'Control de versiones con Git y repositorio en GitHub como base del flujo de desarrollo y despliegue.',
    'plexrag.tech.eyebrow': '// stack tecnológico',
    'plexrag.tech.title': 'Tecnologías y servicios usados',
    'plexrag.tech.angular.name': 'Angular',
    'plexrag.tech.angular.desc': 'Frontend SPA y servicios',
    'plexrag.tech.dotnet.name': '.NET 10',
    'plexrag.tech.dotnet.desc': 'API backend (ASP.NET Core)',
    'plexrag.tech.docker.name': 'Docker',
    'plexrag.tech.docker.desc': 'Empaquetado y despliegue',
    'plexrag.tech.azure.name': 'Azure',
    'plexrag.tech.azure.desc': 'Azure OpenAI — modelos de IA',
    'plexrag.tech.gcp.name': 'Google Cloud',
    'plexrag.tech.gcp.desc': 'Vertex AI / Gemini — modelos de IA',
    'plexrag.tech.oauth.name': 'Google OAuth 2.0',
    'plexrag.tech.oauth.desc': 'Autenticación de usuarios',
    'plexrag.tech.rag.name': 'RAG',
    'plexrag.tech.rag.desc': 'Búsqueda vectorial y recuperación de contexto',
    'plexrag.tech.git.name': 'Git',
    'plexrag.tech.git.desc': 'Control de versiones',
    'plexrag.tech.github.name': 'GitHub',
    'plexrag.tech.github.desc': 'Repositorio y flujo de despliegue',
    'plexrag.final.title': '¿Quieres algo similar para tu producto?',
    'plexrag.final.sub': 'Construyo desde el diseño de arquitectura hasta el despliegue en producción.',
  },
  en: {
    'nav.home': 'Home',
    'nav.about': 'About',
    ...
    'projects.p4.title': 'PlexRAG — AI Assistant for Plex',
    'projects.p4.desc': 'Personal generative-AI app that chats about your Plex media library using RAG, with LLM/Standard and Agent modes, Google authentication, and manageable vector indexing.',
    'projects.p4.cta': 'View project details →',
    ...
    'plexrag.back': '← Back to portfolio',
    'plexrag.eyebrow': '// featured project',
    'plexrag.title': 'PlexRAG',
    'plexrag.tagline': 'A conversational AI assistant, powered by RAG, that answers questions about your own Plex media library — with a standard chat mode and an Agent mode, Google authentication, and manageable vector indexing.',
    'plexrag.cta.live': 'View the live app ↗',
    'plexrag.cta.back': '← Back to portfolio',
    'plexrag.overview.eyebrow': '// what I built',
    'plexrag.overview.title': 'End-to-end RAG on top of a real media library',
    'plexrag.overview.p1': 'PlexRAG is a full-stack personal application that indexes a Plex library catalog (movies, shows, metadata) into a vector store and lets you ask natural-language questions about that content. The chat has two modes: <strong>LLM / Standard</strong>, for direct answers grounded in retrieved context, and <strong>Agent</strong>, where the model can orchestrate tools to resolve more complex queries.',
    'plexrag.overview.p2': 'An admin panel syncs the Plex library sections and can trigger a full <em>reindex</em>, while user management enforces role-based access control (Admin / User) on top of a Google OAuth 2.0 login.',
    'plexrag.shot.caption': 'PlexRAG chat interface in production — LLM/Standard and Agent modes.',
    'plexrag.specs.eyebrow': '// specifications',
    'plexrag.specs.title': 'How it is built',
    'plexrag.specs.s1.title': 'RAG pipeline over Plex',
    'plexrag.specs.s1.desc': 'Syncs Plex library sections and triggers a full vector reindex on demand from the admin panel.',
    'plexrag.specs.s2.title': 'Authentication &amp; roles',
    'plexrag.specs.s2.desc': 'Google OAuth 2.0 login with role-based access control (Admin / User) gating the admin screens.',
    'plexrag.specs.s3.title': 'Angular frontend',
    'plexrag.specs.s3.desc': 'SPA built with Angular (v22) and standalone services calling the API via HttpClient, with routed sections (chat, indexing, users).',
    'plexrag.specs.s4.title': '.NET 10 API',
    'plexrag.specs.s4.desc': 'REST backend on ASP.NET Core Web API over .NET 10, deployed on its own subdomain, decoupled from the frontend.',
    'plexrag.specs.s5.title': 'Docker containers',
    'plexrag.specs.s5.desc': 'Frontend and backend packaged and deployed as independent Docker containers.',
    'plexrag.specs.s6.title': 'Multi-cloud AI',
    'plexrag.specs.s6.desc': 'Language models served from Azure OpenAI and Google Cloud (Vertex AI / Gemini) to power the LLM and Agent modes.',
    'plexrag.specs.s7.title': 'Git &amp; GitHub',
    'plexrag.specs.s7.desc': 'Git version control with a GitHub repository backing the development and deployment workflow.',
    'plexrag.tech.eyebrow': '// tech stack',
    'plexrag.tech.title': 'Technologies &amp; services used',
    'plexrag.tech.angular.name': 'Angular',
    'plexrag.tech.angular.desc': 'SPA frontend &amp; services',
    'plexrag.tech.dotnet.name': '.NET 10',
    'plexrag.tech.dotnet.desc': 'Backend API (ASP.NET Core)',
    'plexrag.tech.docker.name': 'Docker',
    'plexrag.tech.docker.desc': 'Packaging &amp; deployment',
    'plexrag.tech.azure.name': 'Azure',
    'plexrag.tech.azure.desc': 'Azure OpenAI — AI models',
    'plexrag.tech.gcp.name': 'Google Cloud',
    'plexrag.tech.gcp.desc': 'Vertex AI / Gemini — AI models',
    'plexrag.tech.oauth.name': 'Google OAuth 2.0',
    'plexrag.tech.oauth.desc': 'User authentication',
    'plexrag.tech.rag.name': 'RAG',
    'plexrag.tech.rag.desc': 'Vector search &amp; context retrieval',
    'plexrag.tech.git.name': 'Git',
    'plexrag.tech.git.desc': 'Version control',
    'plexrag.tech.github.name': 'GitHub',
    'plexrag.tech.github.desc': 'Repository &amp; deployment workflow',
    'plexrag.final.title': 'Want something like this for your product?',
    'plexrag.final.sub': "I build end-to-end, from architecture design to production deployment.",
  },
};
